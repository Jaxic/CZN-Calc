      ...
      <DeckProvider>
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
          ...
          <section className="container mx-auto px-4 mb-12">
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-gray-800 dark:to-gray-850 rounded-lg shadow-lg p-6 md:p-8 border-2 border-orange-200 dark:border-orange-900">
